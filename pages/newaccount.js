...
const NewAccount = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            password: Yup.string().required('Password is required').min(6, 'Passowrd must have at least 6 characters')
        }),
        onSubmit: values => {
            registerUser(values);
        }
    ...
    return (
        <Layout>
            <div className="md:w-4/5 xl:w-3/5 mx-auto mb-32">
                <h2 className="text-4xl font-sans font-bold text-gray-800 text-center my-4">Create an account</h2>
                {msg && <Alert />}
